...
def register(employee: EmployeeCreate, db: Session = Depends(get_db)):
   ...
   # Remove the employee_code check since it's auto-generated
    ...
    db_employee = Employee(
        #employee_code=employee.employee_code, # Don't provide employee_code - it will be auto-generated by the event listener
